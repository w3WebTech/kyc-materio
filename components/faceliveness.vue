...
import { FaceMesh } from '@mediapipe/face_mesh' // Import FaceMesh
import { Camera } from '@mediapipe/camera_utils' // Import Camera if needed
    ...
    function onResults(
      ...
      if (results.multiFaceLandmarks) {
        ...
        for (const landmarks of results.multiFaceLandmarks) {
          ...
          // Draw additional shapes as needed
          drawInvertedTriangle(canvasCtx, landmarks, 33, 263, 152)
          drawFaceOvalConnector(canvasCtx, landmarks)
          logResults(landmarks)
        }
